...
The strings will always go to the length at which the most left bit's value
 gets bigger than the number in decimal.
If a binary conversion for 0 is attempted, return "0".
*/

/* Recursive, but doesn't solve decimal(0) = "0"
function binary(decimal) {
	if(decimal == 0) return "";
	if(decimal % 2)
	  return binary(Math.floor(decimal / 2)) + "1";
