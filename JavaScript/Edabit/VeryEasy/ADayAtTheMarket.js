/* Edabit
Backpack Bill and Wallet Will set off for the annual festival. As they approach
 the stalls, Bill retorts that he'll be able to bring home more stuff than 
 Will. Taking this as a challenge, Will refutes and a competition spurs into 
 action.
...
Create a function that returns the name of the man who can bring home the most
 items. The parameters are given as follows:
...
function whoWinsTonight(coins, space, price, size) {
  ...
  return ["Tie", "Will", "Bill"][2*(wallet > backpack) + (backpack > wallet)];
}
