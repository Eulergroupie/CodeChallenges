...
function nbYear(p0, r, a, p) {  // (initial pop., growth rate, new people, target)
  let n = 0;  // counter
  while(p0 < p) {  // run until target is surpassed
    p0 += r / 100 * p0 + a;  // increase by growth rate and new people
    n++;
  }
